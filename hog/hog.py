...
def boar_brawl(player_score, opponent_score):
    ...
    score = abs(tens_digit - ones_digit) * 3
    return max(score, 1)
    # END PROBLEM 2
...
def sus_update(num_rolls, player_score, opponent_score, dice=six_sided):
    ...
    new_total = player_score + turn_points
    return sus_points(new_total)
...
def max_scoring_num_rolls(dice=six_sided, times_called=1000):
    ...
    """
    # BEGIN PROBLEM 9
    avg_dice = make_averaged(roll_dice, times_called)
    highest_result = 0
    opti_num_rolls = 1
    for i in range(1, 11):
        avg_result = avg_dice(i, dice)
        if avg_result > highest_result:
            highest_result = avg_result
            opti_num_rolls = i

    return opti_num_rolls
...
def sus_strategy(score, opponent_score, threshold=11, num_rolls=6):
    ...
    print("DEBUG: ", score)
    print("DEBUG: ", boar_score)
    print("DEBUG: ", sus_score)
